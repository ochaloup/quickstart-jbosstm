...
public final class CodeUtils {
     ...
     */
    public static void swallow(RunnableWithException r) {
        try {
            r.run();
        } catch (Throwable t) {
    ...
    /**
     * See {@link #swallow(RunnableWithException)}
     */
    public static void swallowMultiple(RunnableWithException... multiRunnables) {
